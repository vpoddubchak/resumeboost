...
import SuccessStoriesPage from '@/app/[locale]/success-stories/page';
...
describe('SuccessStoriesPage', () => {
  ...
  it('renders the page heading', async () => {
    const Page = await SuccessStoriesPage({ params: Promise.resolve({ locale: 'en' }) });
    render(Page);
  ...
  it('queries prisma with correct ordering (featured first, then newest)', async () => {
    await SuccessStoriesPage({ params: Promise.resolve({ locale: 'en' }) });
